...
public class Constant {
    ...
    // Plugin tasks
    public static final String COLLECT_PUBLISH_INFO_TASK_NAME = "artifactoryPublish";
    public static final String COLLECT_PUBLISH_INFO_TASK_DESCRIPTION = "Collect artifacts to be later used to generate build-info and deploy to Artifactory.";
